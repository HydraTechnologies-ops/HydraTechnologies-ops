...
const AccordionSummary = /*#__PURE__*/React.forwardRef(function AccordionSummary(inProps, ref) {
  ...
  const handleClick = event => {
    ...
    if (typeof slotProps.button === 'function') {
      ...
      (_slotProps$button = slotProps.button(ownerState)) == null || (_slotProps$button$onC = _slotProps$button.onClick) == null ? void 0 : _slotProps$button$onC.call(_slotProps$button, event);
    } else {
      var _slotProps$button2, _slotProps$button2$on;
      (_slotProps$button2 = slotProps.button) == null || (_slotProps$button2$on = _slotProps$button2.onClick) == null ? void 0 : _slotProps$button2$on.call(_slotProps$button2, event);
    }
  };
